...
| 2026-07-14 | Plans-pagina is leeg — oplappen of herbestemmen? | **Herbestemmen.** Geen producent schrijft naar `kanban_plans`; maak de pagina een read-only mensvenster op de spec-/plan-laag en faseer de tabel uit. | [`plans-feature-decision.md`](./plans-feature-decision.md) | zie doc |
